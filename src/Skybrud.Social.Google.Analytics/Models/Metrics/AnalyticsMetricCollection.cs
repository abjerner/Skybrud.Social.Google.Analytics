...
namespace Skybrud.Social.Google.Analytics.Models.Metrics {
    ...
    public class AnalyticsMetricCollection {
        ...
        /// <summary>
        /// Initializes a new collection from the specified <paramref name="metric"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new collection based on the specified array of <paramref name="metrics"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified <see cref="metric"/> to <see cref="collection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new collection based on the specified string array of <see cref="metrics"/>.
        /// </summary>
