...
namespace Skybrud.Social.Google.Analytics.Models.Dimensions {
    ...
    public class AnalyticsDimensionCollection {
        ...
        /// <summary>
        /// Initializes a new collection from the specified <paramref name="dimension"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new collection based on the specified array of <paramref name="dimensions"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified <paramref name="dimension"/> to <paramref name="collection"/>.
        /// </summary>
        /// <param name="collection">The collection to which the dimension should be added.</param>
        /// <param name="dimension">The dimension to be added to the collection.</param>
        /// <returns>An instance of <see cref="AnalyticsDimensionCollection"/>.</returns>
        ...
        /// <summary>
        /// Initializes a new collection based on the specified string array of <paramref name="dimensions"/>.
        /// </summary>
