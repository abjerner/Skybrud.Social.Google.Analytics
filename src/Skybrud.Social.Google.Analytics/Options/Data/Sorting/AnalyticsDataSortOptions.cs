...
namespace Skybrud.Social.Google.Analytics.Options.Data.Sorting {
    ...
    public class AnalyticsDataSortOptions {
        ...
        /// <summary>
        /// Adds the specified sort <paramref name="field"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified <paramref name="dimension"/> as a sort field.
        /// </summary>
        /// <param name="dimension">The dimension to be added.</param>
        /// <param name="order">The order by which the field should be sorted.</param>
        /// <returns>The current instance of <see cref="AnalyticsDataSortOptions"/> for method chaining.</returns>
        ...
        /// <summary>
        /// Adds the specified <paramref name="metric"/> as a sort field.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified <paramref name="dimension"/> as a sort field to be sorted in ascending order.
        /// </summary>
        /// <param name="dimension">The dimension to be added.</param>
        /// <returns>Returns th current instance of <see cref="AnalyticsDataSortOptions"/> for method chaining.</returns>
        ...
        public static AnalyticsDataSortOptions Parse(string str) {
            ...
            for (int j = 0; j < b.Length; j++) {
                ...
                if (AnalyticsMetric.TryGet(m.Groups[1].Value, out var metric)) {
                    options.Add(metric, order);
                } else if (AnalyticsDimension.TryGet(m.Groups[1].Value, out var dimension)) {
